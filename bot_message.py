"""THIS is a file to check if the message should be bot or not"""
BOT_PREFIX = "!!"
KEY_IS_BOT = "is_bot"
...
def valid_message(message):
    """Check to make sure that this is a bot call"""
    if not message.startswith(BOT_PREFIX):
        return {KEY_IS_BOT: False, KEY_BOT_COMMAND: None, KEY_MESSAGE: message}
    message = message[2:]
